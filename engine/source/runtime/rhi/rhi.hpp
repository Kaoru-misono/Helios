...
namespace Helios
{
    ...
    public:
        ...
        virtual auto create_texture(Texture::Kind kind, std::vector<std::string> const& paths, Texture::Format format = Texture::Format::rgb8, bool should_flip = false) -> std::shared_ptr<Texture> = 0;
